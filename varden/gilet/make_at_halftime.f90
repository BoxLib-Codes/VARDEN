...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  subroutine make_at_halftime(mla,rhohalf,sold,snew,in_comp,out_comp,&
                              the_bc_level,dx,t)
    ...
    if (nlevs .eq. 1) then
       ...
       call multifab_physbc(rhohalf(nlevs),out_comp,dm+in_comp,1,&
                            the_bc_level(nlevs),dx(1,:),t)
