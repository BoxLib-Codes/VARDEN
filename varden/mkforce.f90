...
contains
  ...
  subroutine mkvelforce_2d(vel_force,ext_vel_force,gp,rho,u,lapu, &
                           ng_u,ng_rho,dx,bc,visc_coef,visc_fac)
  ...
  subroutine mkvelforce_3d(vel_force,ext_vel_force,gp,rho,u,lapu, &
                           ng_u,ng_rho,dx,bc,visc_coef,visc_fac)
