...
contains
      ...
      subroutine mkflux_nomacvel_2d(s,u,sedgex,sedgey,uadv,vadv,utrans,vtrans,&
...
!     Local variables
      ...
      end subroutine mkflux_nomacvel_2d

      subroutine mkflux_nomacvel_3d(s,u,sedgex,sedgey,sedgez,&
...
!        ******************************************************************
      ...
      end subroutine mkflux_nomacvel_3d

end module mkflux_nomacvel_module
