...
contains 
  ...
  ! used with strang splitting to integrate reactions 0 -> dt
  ...
  ! used with SDC to integrate the system from 0 -> sdc_fac(j)*dt
...
!---------------------------------------------------------------
! The integrals
! make sure to adjust integral to 0 -> (b-a)*dt
!---------------------------------------------------------------
