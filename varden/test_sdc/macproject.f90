...
contains 
  ...
  subroutine macproject(mla,umac,rho,dx,t,the_bc_tower,bc_comp,&
    ...
    call mk_mac_coeffs(nlevs,mla,rho,beta,the_bc_tower,t)
...
1002  format('...  after mac_projection: max of [div (coeff * UMAC) - RHS)]',e15.8)
    ...
    subroutine mk_mac_coeffs(nlevs,mla,rho,beta,the_bc_tower,t)
