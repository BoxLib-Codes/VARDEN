module velpred_lowmemory_module
...
contains
      ...
      subroutine velpred_lowmemory_2d(u,umac,vmac,&
                                      force,lo,dx,dt,&
...
!******************************************************************
      ...
      end subroutine velpred_lowmemory_2d

      subroutine velpred_lowmemory_3d(u, umac,vmac,wmac, &
                                      force,lo,dx,dt, &
                                      phys_bc,adv_bc,ng,use_minion)
...
!******************************************************************
      ...
      end subroutine velpred_lowmemory_3d

end module velpred_lowmemory_module
